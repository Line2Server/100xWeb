...
<!DOCTYPE html>
<html lang="pt-BR">
<head><meta charset="UTF-8"><title>Doações - Admin</title>
...
<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="donations.php" class="nav-item active"><span class="nav-icon">💰</span> Doações</a>
...
<main class="admin-main">
    <header class="admin-header"><h1>Doações</h1><div class="header-actions"><span class="header-time"><?php echo date('d/m/Y H:i'); ?></span></div></header>
    <div class="content-card full-width">
        <div style="padding:60px;text-align:center;color:var(--text-muted);">
            <div style="font-size:3rem;margin-bottom:16px;">💰</div>
            <h3 style="color:var(--text-bright);margin-bottom:8px;font-family:var(--font-display);">Doações</h3>
